class ExercisesController < ApplicationController
  ...
  before_action :set_workout, only: %i[new edit update]
  ...
  def new
    ...
    @path = [Workout.find(params[:workout_id]), @exercise]
  end
  ...
  private
    ...
    def exercise_params
      params.require(:exercise).permit(:name, :weight, :sets, :reps, :workout_id)
    end
